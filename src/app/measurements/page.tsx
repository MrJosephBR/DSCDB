...
export default async function MeasurementsPage() {
  ...
  return (
    <main className="page">
      <section className="page-header"><div><h1>Measurements</h1><p>Sample x compound GC-MS intensities and detection state.</p></div><Link className="button secondary" href="/">Dashboard</Link></section>
