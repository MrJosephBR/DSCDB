...
export default async function PathwaysPage() {
  ...
  return (
    <main className="page">
      <section className="page-header"><div><h1>Pathways</h1><p>Human, conserved, microbial, plant, and external pathway records.</p></div><a className="button secondary" href="/">Dashboard</a></section>
